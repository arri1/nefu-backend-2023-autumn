...
const App = () => {
  ...
  const [getUser, { loading: Userloading, error: Usererror, where: Userdata }] =
  ...
  return (
    ...
    >
      <button className={"open-btn"} onClick={() => setRegActive(true)}>
        {" "}
        Registration
      </button>
      ...
      <Modal active={SignActive} setActive={setSignActive}>
        ...
        >
          ...
          <button
            className={"open-btn"}
            style={{ marginTop: 20, marginBottom: 25, width: 150 }}
            onClick={() => {
              loginUser({
                variables: {
                  where: {
